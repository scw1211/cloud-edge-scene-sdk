"""Fail-closed release packager for one statically fused joint Q4_K_M model.
...
```bash
python -m edge_llm_factory.q4_static_raw16_release validate \\
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    parser = argparse.ArgumentParser(
        description="Build a fail-closed statically fused joint Q4_K_M package"
    )
